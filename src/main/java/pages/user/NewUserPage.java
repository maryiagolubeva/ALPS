...
public class NewUserPage {
    ...
    private final SelenideElement cancelButton = $(By.xpath("//div[@class='dialog']//span[text()='Cancel']"));
    ...
    private final SelenideElement adminListElement = $(By.xpath("//div[@class='customDropDown']//li/span[text()='Admin']"));

    private final SelenideElement userListElement = $(By.xpath("//div[@class='customDropDown']//li/span[text()='User']"));

    private final SelenideElement guestListElement = $(By.xpath("//div[@class='customDropDown']//li/span[text()='Guest']"));

    private final SelenideElement successMessage = $(By.xpath("//section//span[text()='The new user has been registered!']"));
